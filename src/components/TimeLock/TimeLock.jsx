...
import TimeLockMethods from "./TimeLockMethods";
...
export default function TimeLock() {
  ...
  return (
    <div style={{ margin: "auto", display: "flex", gap: "20px", marginTop: "25", width: "70vw" }}>
      ...
      >
        <TimeLockResolver setContract={setContract} contract={contract} />
        ...
        {isDeployedToActiveChain === true && (
          ...
          >
            <TimeLockMethods displayedContractFunctions={displayedContractFunctions} responses={responses} />
          </Form.Provider>
        )}
